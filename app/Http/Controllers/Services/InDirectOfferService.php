    ...
    public function contents($type)
    {
        ...
        $inputs = [
            ...
            [
                ...
                select("select", "brokers_ids", "brokers_ids_select_id$prefix_id", "fas fa-user-tag", "", "select inputSelect$type", "الوسيط", true, brokers(true), "multiple", false, "الوسيط", "text-danger brokers_ids-validation fw-bold ms-5 reset-validation"),
            ]
        ];
