    ...
    public function contents($type)
    {
        ...
        $inputs = [
            ...
            [
                ...
                input("text", "client_buyer_id_number", "client_buyer_id_number_input_id$prefix_id", "fas fa-user", "rtl", "10", "form-control inputText$type", "رقم الهوية", true, "رقم الهوية", "text-danger client_buyer_id_number-validation fw-bold ms-5 reset-validation", false),
